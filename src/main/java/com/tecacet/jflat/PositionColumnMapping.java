 ...
 * 
 */
public class PositionColumnMapping implements ColumnMapping {

    protected Map<Integer, String> columnMapping;

    protected PositionColumnMapping() {
     ...
     */
    public PositionColumnMapping(Map<Integer, String> mapping) {
     ...
     *            array value
     */
    public PositionColumnMapping(String[] mapping) {
